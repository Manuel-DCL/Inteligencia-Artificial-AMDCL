...
imagen = cv2.imread('./media/circulos.jpg')
#cv2.imshow('Imagen original', imagen)
gris = cv2.cvtColor(imagen, cv2.COLOR_BGR2GRAY)

circulos = cv2.HoughCircles(
    gris, cv2.HOUGH_GRADIENT, dp=1.2, minDist=100, 
...
if circulos is not None:
    ...
    cv2.circle(imagen, (referencia_circulo[0], referencia_circulo[1]),referencia_circulo[2], (0,0,255), 2)
